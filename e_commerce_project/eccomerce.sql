...
INSERT INTO `orders` VALUES (20,1500,'2021-10-12',3,3),(25,30500,'2021-09-16',5,4),(26,2000,'2021-10-05',1,1),(30,3500,'2021-08-16',4,2),(50,2000,'2021-10-06',2,1);
...
CREATE TABLE `rating` (
  ...
  KEY `CUS_ID` (`CUS_ID`),
  KEY `SUPP_ID` (`SUPP_ID`),
  CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`CUS_ID`) REFERENCES `customer` (`CUS_ID`),
  CONSTRAINT `rating_ibfk_2` FOREIGN KEY (`SUPP_ID`) REFERENCES `supplier` (`SUPP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-01 19:52:42
